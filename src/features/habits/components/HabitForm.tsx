...
const styles = StyleSheet.create({
  ...
  weekDayOn: { backgroundColor: theme.colors.primary, borderColor: theme.colors.primary },
  ...
  wheel: { flex: 1, height: 220, borderRadius: theme.radius.md, backgroundColor: theme.colors.surfaceAlt },
