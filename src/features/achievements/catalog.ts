...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { key: 'STREAK_7', title: 'Uma semana de fôlego', description: 'Sequência de 7 dias', icon: Flame, color: theme.colors.primary },
  { key: 'STREAK_30', title: 'Mês de aço', description: 'Sequência de 30 dias', icon: Flame, color: theme.colors.primary },
  { key: 'STREAK_100', title: 'Lendário', description: 'Sequência de 100 dias', icon: Crown, color: theme.colors.gold },
  ...
  { key: 'FIRST_SKILL', title: 'Aprendendo a aprender', description: 'Crie sua primeira habilidade', icon: Sparkles, color: theme.colors.skill },
  { key: 'SKILLS_5', title: 'Repertório amplo', description: 'Crie 5 habilidades', icon: Wand2, color: theme.colors.skill },
  { key: 'SKILL_LEVEL_10', title: 'Especialista', description: 'Suba qualquer habilidade ao nível 10', icon: Target, color: theme.colors.skillAlt },
  { key: 'GOLD_1000', title: 'Bolso cheio', description: 'Acumule 1.000 de ouro ganho', icon: Coins, color: theme.colors.gold },
  { key: 'FIRST_SIDEQUEST', title: 'Primeira missão', description: 'Conclua sua primeira missão secundária', icon: Sword, color: theme.colors.skill },
  { key: 'SIDEQUESTS_10', title: 'Caçador de missões', description: 'Conclua 10 missões secundárias', icon: Swords, color: theme.colors.primary },
  ...
  { key: 'RARE_DEATHLESS_LEVEL_25', title: 'Jornada intacta', description: 'Alcance nível 25 sem morrer', icon: Crown, color: theme.colors.success },
];
