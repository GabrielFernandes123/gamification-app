...
const styles = StyleSheet.create({
  ...
  backRow: { minHeight: 40, flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', gap: theme.spacing.sm },
  focusCard: { gap: theme.spacing.md, borderColor: theme.colors.primary, backgroundColor: theme.colors.surfaceAlt },
  heroRow: { flexDirection: 'row', alignItems: 'center', gap: theme.spacing.md, backgroundColor: theme.colors.surfaceAlt },
  metricStrip: { flexDirection: 'row', gap: theme.spacing.sm, borderRadius: theme.radius.md, backgroundColor: theme.colors.surface, padding: theme.spacing.sm },
  metricItem: { flex: 1, minHeight: 56, borderRadius: theme.radius.sm, justifyContent: 'center', paddingHorizontal: theme.spacing.sm },
  exerciseRow: { minHeight: 64, flexDirection: 'row', alignItems: 'center', gap: theme.spacing.md, borderRadius: theme.radius.md, backgroundColor: theme.colors.surfaceAlt, padding: theme.spacing.md },
  ...
  secondaryBtn: { minHeight: theme.sizes.touch, borderRadius: theme.radius.md, borderWidth: 1, borderColor: theme.colors.border, backgroundColor: theme.colors.surface, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: theme.spacing.sm },
  primaryBtn: { minHeight: theme.sizes.touch, borderRadius: theme.radius.md, backgroundColor: theme.colors.primary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: theme.spacing.sm },
